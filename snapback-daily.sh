...
POWERSTATE=""
#NFS Export
NFS_EXPORT="192.168.1.20:/mnt/backup/xenserver/daily"
#MOUNT_PATH="/var/run/sr-mount"
MOUNT_PATH="/backup-daily"
...
for VM in $RUNNING_VMS; do
    ...
    #XVA Backups
    XVA_SCHEDULE=daily
    XVA_RETAIN=$(xe vm-param-get uuid=$VM param-name=other-config param-key=XenCenter.CustomFields.xva_retain_daily)
